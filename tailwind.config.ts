  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "slide-x": { "0%": { transform: "translateX(0)" }, "100%": { transform: "translateX(-50%)" } },
      ...
      animation: {
        ...
        "marquee-left": "marquee-left 16s linear infinite",
        "marquee-right": "marquee-right 16s linear infinite",
      },
    },
  },
